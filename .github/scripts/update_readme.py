...
def generate_markdown(prs: list, is_k8s_member: bool) -> str:
    ...
    lines.append("")
    if is_k8s_member:
        lines.append("<img src=\"https://raw.githubusercontent.com/kubernetes/kubernetes/master/logo/logo.svg\" width=\"18\" height=\"18\" valign=\"middle\" alt=\"Kubernetes\" /> **Love contributing to Open Source** • Kubernetes Org Member ([`kubernetes-sigs`](https://github.com/kubernetes-sigs))")
        lines.append("")
